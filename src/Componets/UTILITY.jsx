      ...
      <div className=" overflow-hidden">
          ...
          <div className="container pt-105 pb-40">
            <div className="row">
              ...
              <p className=" d-xl-block d-none  utitilty_FUDing_text3  ff-grands fw_900 text-32 lh-32 mb-0 text-black opacity-50 text-center ">
                ...
                <p className=" mt-20 about_pheragraph mb-0 ff-inter fw-normal text-16 lh-25 text-black opacty_80">
               ...
               <div className=" mt-26"><Commonbtn text="Buy $GrayGensler" bg="bg-black"/></div>
              </div>
        ...
        <div className="  ">
          <div className=" place_box  mb-5   ">
            <h3 className=" text-black ff-inter fw_900 text-36 lh-43 mb-0 text-center">

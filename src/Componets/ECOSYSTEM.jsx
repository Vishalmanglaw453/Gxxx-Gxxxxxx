    ...
    <>
      <div className="eccosystam_bg_img position-relative">
        <div className="container pt-203 pb-68">
          <div className="row">
            <div className="col-lg-6 col-12 d-flex justify-content-center">
              <img data-aos="zoom-in" src={eccosystam} alt="eccosystam" />
            </div>
            <div className="col-lg-6 col-12 pt-4">
              <div className=" about_pheragraph">
                ...
                <p data-aos="zoom-in" className=" mb-0 ff-inter mt-lg-3 mt-0 fw-normal text-16 lh-25">
                ...
                <div data-aos="zoom-in" className=" pt-33">
        ...
        <img
          ...
          src={eccosystamellipe}
          alt="eccosystamellipe"
        />
        <img
          className="  d-lg-block d-none"
          src={goggleellipes}
